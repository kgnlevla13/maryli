						...
						<div class="blog-box blog-grid text-center product-box">
							<div class="product-img"><img class="img-fluid top-radius-blog" src="<?= admin_public_url('assets/images/') . $m ?>" alt="">
								<div class="product-hover">
									<ul>
										<li title="edit"><a href="<?= admin_url('editblogpost?id=') . $row["blog_id"] ?>"><i class="icon-wand"></i></a></li>
										<li title="delete"><a class="delete" table="blog" column="blog_id" id="<?=$row["blog_id"]?>" onclick="delete_post()" ><i class="icon-trash"></i></a></li>
									</ul>
								</div>
							</div>
							<div class="blog-details-main">
								...
								<hr>
								<h5 class="f-w-600"><?= $row['blogtitle'] ?></h5>
								<p class="blog-bottom-details"><?= cut_text($row['blogcontent'],100) ?></p>
							</div>
						</div>
					</div>
				</div>
